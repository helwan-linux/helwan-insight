...
class MainWindow(QMainWindow):
	...
	def setup_ui(self):
		...
		# 🧱 تهيئة الـ StackedWidget
		self.stacked_widget = QStackedWidget(self.scroll_content)
		self.scroll_layout.addWidget(self.stacked_widget)
